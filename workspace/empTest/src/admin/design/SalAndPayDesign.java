...
import admin.event.SalAndPayEvt;
...
public class SalAndPayDesign extends JFrame{
	...
	public SalAndPayDesign() {
		...
		//테이블형식 #,###적용
		TableRendererUtil.tableNumberRenderer(jtYearSal, 4, 4,false);
	...
	private JPanel payDatePanel() {
		...
		//테이블 형식 #,### 변환
		TableRendererUtil.tableNumberRenderer(jtPayDate, 2, 5,false);
	...
	private JPanel payRecordsPanel() {
	    ...
	    //테이블 형식 #,### 변환
	    TableRendererUtil.tableNumberRenderer(jtPayRecords,4, 7,false);
		return panel;
	}
